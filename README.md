...
1. **Set Up Environment**: Ensure that [Node.js 20 LTS](https://nodejs.org/) and a [Java Runtime Environment (JRE) 8+](https://www.oracle.com/java/technologies/downloads/) are installed on your system.
